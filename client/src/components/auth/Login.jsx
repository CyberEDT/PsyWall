      ...
      <div className="w-full max-w-md relative z-10">
        <div className="mb-8 text-center">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-indigo-500/10 border border-indigo-500/20 mb-4">
             <img src="/logo.jpg" alt="PsyWall Logo" className="w-10 h-10 object-cover rounded-full" />
          </div>
          <h1 className="text-3xl font-black text-white tracking-tight">Access PsyWall</h1>
          <p className="text-sm text-slate-400 mt-2">Authenticate to enter the cognitive firewall.</p>
        </div>
